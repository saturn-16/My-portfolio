  ...
  return (
    <section id="certificates" className="py-24 px-6 md:px-12 bg-[#efebe4] border-b border-sand flex flex-col items-center">
      <div className="max-w-7xl w-full mx-auto flex flex-col items-center">
        ...
        {/* 3D Scene Viewport */}
        <div className="relative flex flex-col items-center justify-center w-full min-h-[460px] sm:min-h-[520px] perspective-[2000px] select-none">
          ...
          <div 
            ...
            className="relative w-[320px] h-[380px] sm:w-[600px] sm:h-[420px] md:w-[720px] md:h-[460px] scale-[0.78] sm:scale-80 md:scale-95 lg:scale-100 transition-all duration-300 flex items-center justify-center"
          >
            ...
            {/* ========================================================================= */}
            <div 
              className={`absolute top-0 h-full bg-[#04251b] border-2 border-amber-500/20 rounded-r-2xl p-4 sm:p-8 flex flex-col justify-between shadow-2xl z-0 transition-all duration-350 ${
                currentPage === 0 
            ...
            >
              ...
              <div className="flex justify-between items-start pl-2 sm:pl-6">
                <Bookmark className="w-5 h-5 sm:w-8 sm:h-8 text-amber-500/60" />
                <span className="text-[7px] sm:text-[9px] font-mono text-[#dfefe4]/30 tracking-widest uppercase">REGISTRY VERIFIED</span>
              </div>

              <div className="space-y-2 sm:space-y-4 pl-2 sm:pl-6 text-left">
                <span className="text-[8px] sm:text-[10px] font-mono uppercase tracking-widest text-[#10be7e] font-bold block">
                  // VERIFICATION COMPLETION
                </span>
                <h3 className="text-xl sm:text-4xl font-oswald text-cream font-extrabold uppercase tracking-wide leading-none">
                  CREDENTIALS<br />REGISTERED.
                </h3>
                <div className="w-8 sm:w-16 h-[2px] bg-amber-500/40" />
                <p className="text-[8px] sm:text-[10px] font-mono text-[#dfefe4]/60 uppercase tracking-widest leading-relaxed">
                  SECURE COMPLIANCE ESTABLISHED.<br />
                  ALL VERIFIED SECTIONS ENCRYPTED.
                </p>
              </div>

              <div className="flex justify-between items-center pl-2 sm:pl-6 font-mono text-[7px] sm:text-[9px] text-[#dfefe4]/40 uppercase tracking-widest border-t border-[#dfefe4]/10 pt-2 sm:pt-4">
                <span>SYSTEM COMPLETED // 2026</span>
                <span className="text-emerald-400 font-bold flex items-center gap-0.5 sm:gap-1">
                  SECURED <CheckCircle className="w-2.5 h-2.5 sm:w-3.5 sm:h-3.5" />
                </span>
              </div>
            </div>
            ...
            >
              ...
              <div 
                ...
                className="absolute inset-0 w-full h-full bg-[#fdfcfe] border border-sand border-l-0 rounded-r-2xl p-3 sm:p-6 flex flex-col justify-between z-20 shadow-lg"
              >
                ...
                <div className="flex justify-between items-start">
                  <div className="flex items-center gap-1.5 sm:gap-2">
                    <div className="w-7 h-7 sm:w-9 sm:h-9 bg-indigo-50 rounded-lg sm:rounded-xl flex items-center justify-center border border-indigo-100 text-indigo-600 font-bold text-[9px] sm:text-xs shadow-xs animate-pulse">
                      CISCO
                    </div>
                    <div>
                      <span className="text-[7px] sm:text-[8px] font-mono uppercase tracking-widest text-neutral-400 block">// SECURITY RADAR</span>
                      <h4 className="text-[9px] sm:text-[11px] font-bold font-mono text-pine uppercase tracking-wider leading-tight">Intro to Cybersecurity</h4>
                    </div>
                  </div>
                  <span className="text-[8px] sm:text-[9px] font-mono font-semibold text-pine bg-pine/5 px-1.5 sm:px-2 py-0.5 rounded-full border border-sand">2024</span>
                </div>

                {/* Certificate Mock Box */}
                <div className="p-2 sm:p-4 rounded-xl bg-neutral-50 border border-sand relative overflow-hidden flex-1 my-2 sm:my-3.5 flex flex-col justify-between">
                  <div className="absolute right-2 bottom-2 opacity-5 pointer-events-none">
                    <Shield className="w-12 h-12 sm:w-20 sm:h-20 text-pine" />
                  </div>

                  <div className="space-y-1 sm:space-y-1.5 text-left">
                    <p className="text-[7.5px] sm:text-[9px] font-mono uppercase tracking-wider text-neutral-400 font-semibold">// CREDENTIAL DETAILS</p>
                    <p className="text-[9px] sm:text-[11px] font-mono text-neutral-600 leading-normal">
                  ...
                  <div className="flex flex-wrap gap-0.5 sm:gap-1 pt-1.5 sm:pt-2.5 border-t border-neutral-100 mt-1">
                    {["Net Defense", "Threat Intel", "Cryptography", "Forensics"].map(tag => (
                      <span key={tag} className="text-[6.5px] sm:text-[7.5px] font-mono bg-white border border-sand px-1 sm:px-1.5 py-0.5 rounded text-neutral-500">{tag}</span>
                    ))}
                  </div>
                </div>

                {/* Footer */}
                <div className="flex justify-between items-center font-mono text-[7px] sm:text-[8px] text-[#9d9282] uppercase tracking-widest border-t border-neutral-100 pt-1.5 sm:pt-2.5">
            ...
            >
              ...
              >
                ...
                <div className="flex justify-between items-start">
                  <div className="flex items-center gap-1.5 sm:gap-2">
                    <div className="w-7 h-7 sm:w-9 sm:h-9 bg-orange-50 rounded-lg sm:rounded-xl flex items-center justify-center border border-orange-100 text-orange-600 font-bold text-[9px] sm:text-xs shadow-xs">
                      AWS
                    </div>
                    <div>
                      <span className="text-[7px] sm:text-[8px] font-mono uppercase tracking-widest text-neutral-400 block">// CLOUD COMPUTING</span>
                      <h4 className="text-[9px] sm:text-[11px] font-bold font-mono text-pine uppercase tracking-wider leading-tight">Certified Practitioner</h4>
                    </div>
                  </div>
                  <span className="text-[8px] sm:text-[9px] font-mono font-semibold text-pine bg-pine/5 px-1.5 sm:px-2 py-0.5 rounded-full border border-sand">2025</span>
                </div>

                {/* Certificate Mock Box */}
                <div className="p-2 sm:p-4 rounded-xl bg-neutral-50 border border-sand relative overflow-hidden flex-1 my-2 sm:my-3.5 flex flex-col justify-between">
                  <div className="absolute right-2 bottom-2 opacity-5 pointer-events-none">
                    <Award className="w-12 h-12 sm:w-20 sm:h-20 text-pine" />
                  </div>
            ...
            >
              ...
              >
                ...
                <div className="flex justify-between items-start">
                  <div className="flex items-center gap-1.5 sm:gap-2">
                    <div className="w-7 h-7 sm:w-9 sm:h-9 bg-teal-50 rounded-lg sm:rounded-xl flex items-center justify-center border border-teal-100 text-teal-600 font-bold text-[9px] sm:text-xs shadow-xs animate-pulse">
                      AI
                    </div>
                    <div>
                      <span className="text-[7px] sm:text-[8px] font-mono uppercase tracking-widest text-neutral-400 block">// GOOGLE CLOUD</span>
                      <h4 className="text-[9px] sm:text-[11px] font-bold font-mono text-pine uppercase tracking-wider leading-tight">Generative AI Specialist</h4>
                    </div>
                  </div>
                  <span className="text-[8px] sm:text-[9px] font-mono font-semibold text-pine bg-pine/5 px-1.5 sm:px-2 py-0.5 rounded-full border border-sand">2025</span>
                </div>
                ...
                <div className="p-2 sm:p-4 rounded-xl bg-neutral-50 border border-sand relative overflow-hidden flex-1 my-2 sm:my-3.5 flex flex-col justify-between">
                  <div className="absolute right-2 bottom-2 opacity-5 pointer-events-none">
                    <Sparkles className="w-12 h-12 sm:w-20 sm:h-20 text-pine" />
                  </div>
            ...
            >
              ...
              >
                ...
                <div className="flex justify-between items-start">
                  <div className="flex items-center gap-1.5 sm:gap-2">
                    <div className="w-7 h-7 sm:w-9 sm:h-9 bg-blue-50 rounded-lg sm:rounded-xl flex items-center justify-center border border-blue-100 text-blue-600 font-bold text-[9px] sm:text-xs shadow-xs">
                      G
                    </div>
                    <div>
                      <span className="text-[7px] sm:text-[8px] font-mono uppercase tracking-widest text-neutral-400 block">// GOOGLE CAREER</span>
                      <h4 className="text-[9px] sm:text-[11px] font-bold font-mono text-pine uppercase tracking-wider leading-tight">IT Support Professional</h4>
                    </div>
                  </div>
                  <span className="text-[8px] sm:text-[9px] font-mono font-semibold text-pine bg-pine/5 px-1.5 sm:px-2 py-0.5 rounded-full border border-sand">2025</span>
                </div>
            ...
            >
              ...
              <div 
                style={{ backfaceVisibility: "hidden" }}
                className="absolute inset-0 w-full h-full bg-[#04251b] border-2 border-amber-500/20 rounded-r-2xl p-4 sm:p-8 flex flex-col justify-between shadow-2xl z-20"
              >
                ...
                <div className="flex justify-between items-start pl-2 sm:pl-6">
                  <Bookmark className="w-5 h-5 sm:w-8 sm:h-8 text-amber-500/60" />
                  <span className="text-[7px] sm:text-[9px] font-mono text-amber-500/40 tracking-widest uppercase">REG. CODE // 1612</span>
                </div>
                ...
                <div className="space-y-2 sm:space-y-4 pl-2 sm:pl-6 text-left">
                  ...
                  <h3 className="text-xl xs:text-2xl sm:text-5xl font-oswald text-cream font-extrabold uppercase tracking-wide leading-none">
                    VERIFIED<br />CREDENTIALS
                  </h3>
                  <div className="w-8 sm:w-16 h-[2px] bg-amber-500/40" />
                  <p className="text-[8px] sm:text-[10px] font-mono text-[#dfefe4]/60 uppercase tracking-widest">
                ...
                <div className="flex justify-between items-center pl-2 sm:pl-6 font-mono text-[7px] sm:text-[9px] text-[#dfefe4]/40 uppercase tracking-widest border-t border-[#dfefe4]/10 pt-2 sm:pt-4">
                  <span>EST. 2026</span>
                  <span className="text-amber-500 font-bold animate-pulse text-[7px] sm:text-[9px]">TAP TO OPEN →</span>
                </div>
              </div>
              ...
              <div 
                ...
                className="absolute inset-0 w-full h-full bg-[#fcfbfa] border border-sand border-r-0 rounded-l-2xl p-3 sm:p-6 flex flex-col justify-between shadow-inner z-10"
              >
                {/* Crease shadow */}
                <div className="absolute top-0 right-0 w-6 h-full bg-gradient-to-l from-black/15 to-transparent pointer-events-none" />

                <div className="space-y-2 sm:space-y-4 text-left">
                  <span className="text-[7px] sm:text-[8px] font-mono uppercase tracking-widest text-neutral-400 block">// INDEX REGISTER</span>
                  <h4 className="text-lg sm:text-2xl font-oswald text-pine font-extrabold uppercase tracking-wide leading-none">
                    TABLE OF SPREADS
                  </h4>
                  <p className="text-[9px] sm:text-[11px] font-mono text-neutral-600 leading-relaxed max-w-xs">
                    Verified certificates index, showcasing accredited certifications from Google, Amazon Web Services, and Cisco Academy.
                  </p>
                </div>

                <div className="space-y-1.5 sm:space-y-2 font-mono text-[8px] sm:text-[10px] text-neutral-500 uppercase tracking-wider pl-2 sm:pl-4 border-l border-sand">
                  <div className="flex justify-between border-b border-neutral-100 pb-1">
                    <span>1. Google IT Support</span>
                    <span className="text-emerald-600 font-bold">PAGE 1</span>
                  </div>
                  <div className="flex justify-between border-b border-neutral-100 pb-1">
                    <span>2. Google Gen AI</span>
                    <span className="text-emerald-600 font-bold">PAGE 2</span>
                  </div>
                  <div className="flex justify-between border-b border-neutral-100 pb-1">
                    <span>3. AWS Practitioner</span>
                    <span className="text-emerald-600 font-bold">PAGE 3</span>
                  </div>
                  <div className="flex justify-between pb-0.5">
                    <span>4. Cisco Cyber Intro</span>
                    <span className="text-emerald-600 font-bold">PAGE 4</span>
                  </div>
                </div>

                <span className="text-[7px] sm:text-[8px] font-mono text-neutral-400 text-right block tracking-widest uppercase">PAGE I // TABLE OF SPREADS</span>
              </div>
            </motion.div>
